  ...
  render() {
    ...
    return (
      <div className="card bordered" style={{ padding: "60px 80px" }}>
        ...
        <h5 className="h2 text-steal mb-4">
          ${itemDetails.price} <span className="text-gray-500 fw-light">/{itemDetails.unit}</span>
        </h5>
        ...
        <h6 className="text-gray-500 fw-light" style={{ marginBottom: 40 }}>
          You will pay <span className="text-gray-900">${itemDetails.price * data.duration} USD</span> /{" "}
          <span className="text-gray-900">
            {data.duration} {itemDetails.unit}
          </span>
        </h6>

        <Button className="btn" isPrimary isBlock hasShadow onclick={this.startBooking}>
          Continue to Book
        </Button>
      </div>
    );
