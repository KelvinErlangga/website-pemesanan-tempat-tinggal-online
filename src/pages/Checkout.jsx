...
import Stepper, { Numbering, Meta, Controller, MainContent } from "elements/Stepper";
...
export default class Checkout extends Component {
  ...
  componentDidMount() {
    window.scroll(0, 0);
    document.title = "Checkout | Vinstay";
  }
            ...
            <>
              ...
              {CurrentStep === "payment" && (
                <Controller>
                  ...
                  <Button className="btn" type="link" isBlock isLight onClick={prevStep}>
                    Cancel
                  </Button>
                </Controller>
              )}
              {CurrentStep === "completed" && (
                <Controller>
                  <Button className="btn" type="link" isBlock isPrimary hasShadow href="/.">Back to Home</Button>
                </Controller>
              )}
            </>
          )}
